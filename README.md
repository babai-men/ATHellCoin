...
![Security](https://img.shields.io/badge/Security-Immutable-brightgreen)
...
- **Circulating Supply at Start:** 999,000,000
- **Burn Fee:** 0.1% (Immutable)

### 📊 Tokenomics
| Sector | Plan | Actual Balance | Burnt Amount 🔥 |
| :--- | :--- | :--- | :--- |
| **DEX Liquidity** | 50% | **499,500,000** | 500,000 |
| **Presale & Rewards**| 30% | **299,700,000** | 300,000 |
| **CEX Liquidity** | 10% | **99,900,000** | 100,000 |
| **Team & Marketing** | 5% | **49,950,000** | 50,000 |
| **Reserve** | 5% | **49,950,000** | 50,000 |

### 🔒 Security (Hardcore Level)
1. **Immutable Fee:** The 0.1% burn rate is locked forever. Authority is disabled.
2. **Revoked Authority:** Mint and freeze functions are permanently destroyed.
3. **Burnt LP:** LP tokens (Hell/USDC) will be sent to the incinerator address immediately after pool creation.
...
- **Начальная эмиссия:** 1,000,000,000
- **Предложение на старте:** 999,000,000

### 📊 Токеномика
| Сектор | План | Баланс кошелька | Сгорело при переводе 🔥 |
| :--- | :--- | :--- | :--- |
| **DEX Liquidity** | 50% | **499,500,000** | 500,000 |
| **Presale & Rewards**| 30% | **299,700,000** | 300,000 |
| **CEX Liquidity** | 10% | **99,900,000** | 100,000 |
...
1. **Immutable Fee:** Комиссия 0.1% зафиксирована. Право на изменение настроек отозвано.
2. **Revoked Authority:** Функции допечатки и заморозки полностью отключены.
3. **Burnt LP:** LP-токены (Hell/USDC) сжигаются сразу после создания пула.

---

## ⚙️ How to Trade / Как торговать
- **Network:** Solana (Token-2022)
- **Slippage:** 0.2% - 0.5% (Recommended for 0.1% tax)
- **Contract:** `[PASTE_YOUR_TOKEN_ADDRESS_HERE]`
